...
export default function PlaceCard({ place, score, footer }) {
  ...
  return (
    <button
      ...
      className="tap-highlight group w-full overflow-hidden rounded-2xl border border-border bg-card text-left active:scale-[0.99]"
    >
      ...
      <div className="p-3">
        ...
        <h3 className="mt-0.5 line-clamp-1 font-semibold text-foreground">{place.name}</h3>
